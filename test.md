...
Welcome to the OpenG2P documentation test page!
...
implemented. The OpenG2P documentation team uses this page as "note to self"
...
- [a markdown link](https://openg2p.com/)
https://github.com/openg2p/openg2p.github.io/tree/master/openg2p-cloud/images
- [a markdown link that opens in a new window](https://openg2p.com/){: target="_blank" class="_" }
...
- <a href="https://openg2p.com/">an HTML link</a>

- <a href="https://openg2p.com/" target="_blank" class="_">an HTML link that opens in a new window</a>

- A link to a Github PR in `openg2p/openg2p`: {% include github-pr.md pr=28199 %}

- A link to a Github PR in `openg2p/openg2p.github.io`: {% include github-pr.md repo=openg2p.github.io pr=9999 %}

  - You can specify `org=foo` to use a Github organization other than OpenG2P

- A link to an auto-generated reference page that we pull in during docs builds:
[/erp/reference/builder/#env](/erp/reference/builder/#env).

  - If you can't find a reference page in the `openg2p.github.io`
  GitHub repository, but see it out on `docs.openg2p.com`, you can
  surmise that it's probably auto-generated from the codebase.
  (FYI, to view the markdown source for the file, just click
  **Edit this page** on `docs.openg2p.com`. But don't use that URL in your docs.)
  ...
  your docs are published on [docs.openg2p.com](/).
...
- A small cute image that is a link. The extra newline here makes it not show
  ...
  [![a small cute image](/images/footer_moby_icon.png)](https://www.openg2p.com/)
...
[OpenG2P 101: Introduction to OpenG2P](https://www.youtube.com/watch?v=V9IJj4MzZBc "OpenG2P 101: Introduction to OpenG2P"){:target="_blank" class="_"}
...
[/openg2p-cloud/images/](https://github.com/openg2p/openg2p.github.io/tree/master/openg2p-cloud/images).
...
<table>
  ...
  <td>This is some test text. <br><br>This is more <b>text</b> on a new line. <br><br>Lorem ipsum dolor <tt>sit amet</tt>, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
    ...
    <td>This is some more text about the right hand side. There is a <a href="https://github.com/openg2p/openg2p-ce/blob/master/components/cli/experimental/README.md" target="_blank" class="_">link here to the OpenG2P Experimental Features README</a> on GitHub. In tables, links need to be `<a href="..."></a>`. <br><br>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</td>
  </tr>
  <tr>
  <td>
...
[openg2p.github.io](https://github.com/openg2p/openg2p.github.io) in
`_data/glossary.yaml`. The glossary publishes to
[https://docs.openg2p.com/glossary/](/glossary/).
...
`site.openg2p_ce_version`. To use them, use Liquid like:

```liquid
{% raw %}{{ site.openg2p_ce_version }}{% endraw %}
```

The current value of `site.openg2p_ce_version` is
{{ site.openg2p_ce_version }}.
...
To generate this message, OpenG2P took the following steps:
 1. The OpenG2P client contacted the OpenG2P daemon.
 2. The OpenG2P daemon pulled the "hello-world" image from the OpenG2P Hub.
 3. The OpenG2P daemon created a new container from that image which runs the
    executable that produces the output you are currently reading.
 4. The OpenG2P daemon streamed that output to the OpenG2P client, which sent it
    to your terminal.

To try something more ambitious, you can run an Ubuntu container with:
 $ docker run -it ubuntu bash

Share images, automate workflows, and more with a free OpenG2P ID:
 https://hub.openg2p.com/

For more examples and ideas, visit:
 https://docs.openg2p.com/erp/userguide/
...
[`_scss/_notes.scss`](https://github.com/openg2p/openg2p.github.io/blob/master/_scss/_notes.scss)
...
```bash
$ echo "deb https://packages.openg2p.com/1.12/apt/repo ubuntu-trusty main" | sudo tee /etc/apt/sources.list.d/openg2p.list
```
...
```powershell
Install-Module OpenG2PMsftProvider -Force
Install-Package OpenG2P -ProviderName OpenG2PMsftProvider -Force
[System.Environment]::SetEnvironmentVariable("DOCKER_FIPS", "1", "Machine")
Expand-Archive openg2p-18.09.1.zip -DestinationPath $Env:ProgramFiles -Force
```
...
```conf
#
# example Dockerfile for https://docs.openg2p.com/examples/postgresql_service/
#
...
RUN    /etc/init.d/postgresql start &&\
    psql --command "CREATE USER openg2p WITH SUPERUSER PASSWORD 'openg2p';" &&\
    createdb -O openg2p openg2p
...
```yaml
authorizedkeys:
  image: openg2pcloud/authorizedkeys
